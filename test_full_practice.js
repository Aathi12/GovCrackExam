...
const allSubtopics = new Set(["Blood Relations", "Coded Language", "Dictionary Order", "Letter-cluster Analogy / Series", "Mathematical Operations", "Syllogism"]);
...
assert(validTopics, "4. Only six valid topics occur");
