...
// Expected topics
const expectedTopics = ["Blood Relations", "Coded Language", "Dictionary Order", "Letter-cluster Analogy / Series", "Mathematical Operations", "Syllogism", "Number/Figure Series", "Classification (Odd One Out)", "Analogy (Word/Number)"];
const actualTopics = new Set(questions.map(q => q.subtopic));
const topicsValid = [...actualTopics].every(t => expectedTopics.includes(t)) && actualTopics.size === 9;
assert(topicsValid, "All nine expected topics are strictly represented");
