...
assert(questions.length === 179, "Exactly 179 questions exist");
...
// Expected topics
const expectedTopics = ["Blood Relations", "Coded Language", "Dictionary Order", "Letter-cluster Analogy / Series", "Mathematical Operations", "Syllogism"];
const actualTopics = new Set(questions.map(q => q.subtopic));
const topicsValid = [...actualTopics].every(t => expectedTopics.includes(t)) && actualTopics.size === 6;
assert(topicsValid, "All six expected topics are strictly represented");
